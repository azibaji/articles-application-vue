<template>
    <div class="tag">
        <div class="tag__header">
            <div class="back">
                <router-link :to="{ name: 'article', params: { slug: pastArticle }}">
  ...
  components: { ArticleItem },
    data(){
        return{
            ...
            pastArticle: this.$route.params.articleName,
            articles:[]
        }
    },
    created(){
    ...
    methods:{
        getArticlesByTag(){
            this.axios.get(`${process.env.VUE_APP_URL}/articles?tag=${this.tag}`)
            .then(response => {
